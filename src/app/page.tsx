          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted border mb-8">
              ...
              <span className="text-sm text-muted-foreground">
                The modern freelancer workspace
              </span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
              Proposals, contracts, invoices, and payments — all in one place.
              Stop juggling tools and start impressing clients.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Create stunning proposals in minutes with templates and
                e-signature support
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Track billable hours effortlessly and convert them to invoices
                instantly
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Give clients a branded portal to view projects, approve work,
                and make payments
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Protect yourself with legally-vetted contract templates and
                e-signatures
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border bg-card hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Set up automated reminders, recurring invoices, and follow-up
                emails
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 rounded-3xl bg-primary text-primary-foreground">
            ...
            <p className="text-lg mb-8 opacity-90">
              Join thousands of freelancers who trust clienx with their client
              work
            </p>
